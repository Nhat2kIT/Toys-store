                            ...
                            <div class="footer-text">
                                <ul>
                                    <li>
                                        ...
                                        <p>504 Hiệp Thành, Đại lộ Bình Dương,</p>
                                        <p>Shop đồ chơi Thiên Long</p>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <p>22050004@student.bdu.edu.vn</p>
                                        <p>22050010@student.bdu.edu.vn</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-3 r-margin-top wide-mobile">
                        <div class="single-text">
                            ...
                            <div class="clearfix instagram">
                                <ul>
                                     <li><a href="https://www.facebook.com/Nhat.Y.2000?locale=vi_VN" target="_blank"><img src="public/img/footer/in1.png" alt="Facebook" /></a></li>
                                     <li><a href="https://zalo.me/84383330056" target="_blank"><img src="https://cdn.haitrieu.com/wp-content/uploads/2022/01/Logo-Zalo-Arc.png" alt="Zalo" width="60" height="60" /></a></li>
                                     <li><a href="mailto:22050004@student.bdu.edu.vn"><img src="public/img/footer/in3.png" alt="Email" /></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <p>&copy; Đồ chơi Thiên Long. All Rights Reserved.</p>
                </div>
